    ...
    <nav className="bg-white text-black shadow-md py-4">
      <div className="container mx-auto flex md:flex-row items-center justify-between">
        ...
        <div
          ...
          } fixed inset-0 top-16 left-0 md:relative md:flex md:flex-grow md:justify-center md:top-0 md:inset-auto md:w-auto md:bg-transparent bg-white shadow-md md:shadow-none`}
        >
